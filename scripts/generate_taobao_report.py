...
3. **劣势/短板** — 客观指出的不足和风险点
4. **竞品深度分析** — 重点分析Top 5产品的竞争策略：
   - 每个产品的标题卖点拆解（从标题关键词反推其主打方向）
   - 价格定位分析（高价/中价/低价策略分别占据什么生态位）
   - 成功因素：为什么这个产品能排在前面（销量驱动？品牌驱动？价格驱动？）
   - 可复制的差异化方向：从头部产品中找到未被满足的需求缝隙
5. **市场机会** — 从价格带空白、头部产品策略等维度发现可落地的选品方向
